<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 class="text-3xl font-bold pt-8 lg:pt-0">Sacramental</h1>
			...
			<div class="pt-12 pb-8 flex flex-wrap md:flex-nowrap justify-center gap-6 w-full">
				<form class="rounded px-8 pt-6 pb-8 mb-4 w-full ala-form-sacramental">
					<div class="mb-4">
						...
						<input class="shadow appearance-none border rounded w-full py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline ala-admin-sacramental-link" type="url">
						<p class="text-red-500 text-xs italic ala-admin-sacramental-link-invalid"></p>
					</div>
					<div class="flex items-center justify-between">
						<button class="w-full bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full ala-admin-sacramental-button-submit" type="button">
							Salvar
						</button>
					</div>
				</form>
