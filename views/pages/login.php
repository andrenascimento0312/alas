			...
			<div class="pt-12 pb-8 flex flex-wrap md:flex-nowrap justify-center gap-6 w-full">
				<form class="rounded px-8 pt-6 pb-8 mb-4 w-full ala-form-sacramental">
					<div class="mb-4">
						...
						<input class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline ala-login-email" id="username" type="email" placeholder="exemplo@exemplo.com">
					...
					<div class="mb-4">
						...
						<input class="shadow appearance-none border rounded w-full py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline ala-sacramental-phone" id="password" type="password" placeholder="*****">
						<p class="text-red-500 text-xs italic ala-password-invalid"></p>
					</div>
					<div class="flex items-center justify-between">
						<button class="w-full bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full ala-login-button-submit" type="button">
							Login
						</button>
					</div>
				</form>
